...
async def main_flow(target_jio_count):
    async with aiohttp.ClientSession() as session:
        ...
        if bal is None:
            ...
            return
        print(f"{C.GRN}💰 Sniper Started! Target: {target_jio_count} true Jio numbers. Current Balance: ₹{bal}{C.RST}")
        ...
        try:
            # We want to buy a batch size larger than the target because 90% are usually non-Jio
            ...
            while true_jio_secured < target_jio_count:
                ...
                if purchased:
                    ...
                    for p, carrier_name in zip(purchased, carriers):
                        ...
                        if true_jio_secured >= target_jio_count:
                            # We already met our target, cancel any extra numbers we bought
...
def main():
    parser = argparse.ArgumentParser(description="UOTP Jio Infinite Sniper")
